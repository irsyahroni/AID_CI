			...
			<div class="col-md-10">
				...
				<?= form_open_multipart('admin/products/update/' . $id, ['class'=>'form-horizontal']) ?>
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
						<label for="inputPassword3" class="col-sm-2 control-label">Donated</label>
						<div class="col-sm-10">
						  <input type="text" class="form-control" name="donated" placeholder="" value="<?= set_value('donated') ?>">
						</div>
					  </div>
